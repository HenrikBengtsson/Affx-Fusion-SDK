...
import affymetrix.calvin.data.ProbeSetMultiDataCopyNumberVariationRegionData;
import affymetrix.calvin.data.ProbeSetMultiDataCytoRegionData;
import affymetrix.calvin.data.DmetBiAllelicData;
import affymetrix.calvin.data.DmetMultiAllelicData;
import affymetrix.calvin.data.DmetCopyNumberData;
...
import affymetrix.calvin.data.ChromosomeSegmentDataEx;
import affymetrix.calvin.data.FamilialSample;
import affymetrix.calvin.data.FamilialSegmentOverlap;
...
public class FusionCHPMultiDataData extends FusionCHPData {
	 ...
	 * @param index
	 *          The row index.
	 * @return The copy number results.
	 */
	public ProbeSetMultiDataCopyNumberData getCopyNumberEntry(MultiDataType dataType, int index) throws IOException,
         ...
         * @return The cyto region results.
         */
        public ProbeSetMultiDataCopyNumberVariationRegionData getCopyNumberVariationRegionEntry(MultiDataType dataType, int index)
                throws IOException, UnsignedOutOfLimitsException {
            return chpData.getCopyNumberVariationEntry(dataType, index);
        }
         ...
         * @return The cyto region results.
         */
        public ProbeSetMultiDataCytoRegionData getCytoRegionEntry(MultiDataType dataType, int index)
                throws IOException, UnsignedOutOfLimitsException {
            return chpData.getCytoEntry(dataType, index);
        } 
	...
	public ProbeSetMultiDataExpressionData getExpressionEntry(MultiDataType dataType, int index) throws IOException,
        ...
        /** Gets the dmet copy number data.
        * @param dataType The data type
        * @param index The row index.
        * @return The results.
        */
        public DmetCopyNumberData getDmetCopyNumberDataEntry(MultiDataType dataType, int index) throws IOException,
			UnsignedOutOfLimitsException {
            return chpData.getDmetCopyNumberEntry(dataType, index);
        }

        /** Gets the dmet bi-allelic data.
        * @param dataType The data type
        * @param index The row index.
        * @return The results.
        */
        public DmetBiAllelicData getDmetBiAllelicDataEntry(MultiDataType dataType, int index) throws IOException,
			UnsignedOutOfLimitsException {
            return chpData.getDmetBiAllelicEntry(dataType, index);
        }

        /** Gets the dmet multi-allelic data.
        * @param dataType The data type
        * @param index The row index.
        * @return The results.
        */
        public DmetMultiAllelicData getDmetMultiAllelicDataEntry(MultiDataType dataType, int index) throws IOException,
			UnsignedOutOfLimitsException {
            return chpData.getDmetMultiAllelicEntry(dataType, index);
        }
    ...
    */
    public ChromosomeSegmentData getChromosomeSegmentEntry(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
            return chpData.getChromosomeSegmentEntry(dataType, index);
    }
    ...
    */
    public ChromosomeSegmentDataEx getChromosomeSegmentEntryEx(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
            return chpData.getChromosomeSegmentEntryEx(dataType, index);
    }
    ...
    */
    public ChromosomeMultiDataSummaryData getChromosomeSummaryEntry(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
            return chpData.getChromosomeSummaryEntry(dataType, index);
    }
    ...
    */
    public FamilialSegmentOverlap getFamilialSegmentOverlapEntry(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
            return chpData.getFamilialSegmentOverlapEntry(dataType, index);
    }
    ...
    */
    public FamilialSample getFamilialSampleEntry(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
            return chpData.getFamilialSampleEntry(dataType, index);
    }

    /** Gets the allele peaks entry.
    * @param dataType The data type
    * @param index The row index.
    * @return The results.
    */
    public AllelePeaks getAllelePeaksEntry(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
            return chpData.getAllelePeaksEntry(dataType, index);
    }

	/** Gets the probe set data.
     * @param dataType The data type
	 * @param index The row index.
     * @return The AB signals
	 */
	public MarkerABSignals getMarkerABSignalsEntry(MultiDataType dataType, int index) throws IOException,
        UnsignedOutOfLimitsException {
