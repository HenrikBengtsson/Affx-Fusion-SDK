...
public class FusionCHPHeader {
	 ...
	 */
	public BackgroundZoneInfo getBackgroundZoneInfo() throws IOException, UnsignedOutOfLimitsException {
		if (gcosHeader != null) {
	 ...
	 */
	public BackgroundZoneType getBackgroundZone(int x, int y) throws IOException, UnsignedOutOfLimitsException {
		if (gcosHeader != null) {
