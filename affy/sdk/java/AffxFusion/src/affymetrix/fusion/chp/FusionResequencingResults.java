...
public class FusionResequencingResults {
	 ...
	 */
	public List<Byte> getCalledBases() throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 */
	public byte getCalledBase(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 */
	public List<Float> getScores() throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 * @return The score.
	 */
	public float getScore(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 */
	public List<FusionForceCallType> getForceCalls() throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 */
	public FusionForceCallType getForceCall(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 */
	public List<FusionBaseCallType> getOrigCalls() throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
	 ...
	 */
	public FusionBaseCallType getOrigCall(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosResult != null) {
