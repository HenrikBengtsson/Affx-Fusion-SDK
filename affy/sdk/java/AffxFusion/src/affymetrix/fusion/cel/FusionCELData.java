...
public class FusionCELData {
	 ...
	 *          The CEL file entry.
	 */
	public void getEntry(int index, FusionCELFileEntryType entry) throws IOException, UnsignedOutOfLimitsException {
	 ...
	 *          The CEL file entry.
	 */
	public void getEntry(int x, int y, FusionCELFileEntryType entry) throws IOException, UnsignedOutOfLimitsException {
	 ...
	 */
	public float getIntensity(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosFile != null) {
	 ...
	 * @return The CEL file intensity.
	 */
	public float getIntensity(int x, int y) throws IOException, UnsignedOutOfLimitsException {
	 ...
	 */
	public float getStdv(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosFile != null) {
	 ...
	 * @return The CEL file stdv value.
	 */
	public float getStdv(int x, int y) throws IOException, UnsignedOutOfLimitsException {
	 ...
	 */
	public short getPixels(int index) throws IOException, UnsignedOutOfLimitsException {
		if (gcosFile != null) {
	 ...
	 * @return The CEL file pixel count.
	 */
	public short getPixels(int x, int y) throws IOException, UnsignedOutOfLimitsException {
	...
	public List<ParameterNameValue> getDataSetParameters(String setName) {
		if (gcosFile != null) {
			...
			return calvinFile.getDataSetParameters(setName);
		}
		return null;
	}
	...
	public void setActiveDataGroup(String groupName) {
		if (calvinFile != null)
                    calvinFile.setActiveDataGroup(groupName);
	}

    /* Is this a multi-color CEL file? */
    public boolean isMultiColor() {
        if (calvinFile != null)
            return calvinFile.isMultiColor();
        return false;
    }
