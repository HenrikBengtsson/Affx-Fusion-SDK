...
public class CDFProbeInformation {
	...
	/** The size of the probe object as stored in the XDA CDF file, version 4+. */
        public static final int PROBE_SIZE_V2 = (4 + 4 + 2 + 2 + 1 + 1 + 2 + 2);
	...
	public void setTBase(char value) {
        ...
        /** The probe length */ 
        public void setProbeLength(short len) {
            probeLength = len;
        }

        /** The probe grouping */ 
        private short probeGrouping; 

        /** The probe grouping */ 
        public short getProbeGrouping() {
            return probeGrouping;
        }
        
        /** The probe grouping */ 
        public void setProbeGrouping(short g) {
            probeGrouping = g;
        }
