...
public class CHPData extends ChpDataBase {
	 ...
	 */
	public void getBackgroundZone(int row, CHPBackgroundZone zone) throws IOException, UnsignedOutOfLimitsException {
	...
	public void getEntry(int row, CHPReseqEntry e) throws IOException, UnsignedOutOfLimitsException {
	...
	/** Gets the expression entry (probe set). */
	public void getEntry(int row, CHPUniversalEntry e) throws IOException, UnsignedOutOfLimitsException {
	 ...
	 *          The data object to be filled
	 */
	public void getForceCall(int row, CHPReseqForceCall force) throws IOException, UnsignedOutOfLimitsException {
		prepareForceDataSet();
	 ...
	 */
	public void getOrigCall(int row, CHPReseqOrigCall orig) throws IOException, UnsignedOutOfLimitsException {
		prepareOrigDataSet();
